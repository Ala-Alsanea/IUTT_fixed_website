...
<head>
  ...
  <?php
   ...
   // if ($_SERVER['HTTP_HOST']=='localhost') { ?>
           ...
           <link href="<?php echo $BaseUrl; ?>backEnd/assets/images/faveicon.png" rel="shortcut icon" type="image/png">
             <link rel="stylesheet" href="<?php echo $BaseUrl; ?>/assets/global/plugins/bootstrap/dist/css/bootstrap.3.3.6.min.css" >
             <link href="<?php echo $BaseUrl; ?>/assets/global/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
               <link href="<?php echo $BaseUrl; ?>/assets/global/plugins/datatables/datatables.min.css" rel="stylesheet" type="text/css" />
              <link href="<?php echo $BaseUrl; ?>/assets/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap-rtl.css" rel="stylesheet" type="text/css" />
              
            <!--  <link rel="stylesheet" href="<?php echo $BaseUrl; ?>/global/plugins/bootstrap/dist/fonts/glyphicons.css" > -->
           <script src="<?php echo $BaseUrl; ?>/assets/global/plugins/jquery/jquery-1.11.0.min.js"></script>
               <script src="<?php echo $BaseUrl; ?>/assets/global/plugins/bootstrap/dist/js/bootstrap.min.js"></script>
                 <link href="<?php echo $BaseUrl; ?>/assets/global/plugins/bootstrap3-editable/css/bootstrap-editable.css"
          rel="stylesheet"/> 
          


        <script src="<?php echo $BaseUrl; ?>/assets/global/plugins/bootstrap3-editable/js/bootstrap-editable.min.js"></script>  
...
<?php endif; ?>
  ...
  <script src="<?php echo $BaseUrl; ?>/assets/global/scripts/datatable.js" type="text/javascript"></script>
     ...
     <script src="<?php echo $BaseUrl; ?>/assets/global/scripts/table-datatable.js" type="text/javascript"></script>
