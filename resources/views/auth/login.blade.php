    ...
    <div class="app" id="app">
        ...
        <div class="app-content content p-a-md">
            ...
            <div class="content-wrapper">
                            ...
                            <div class="card bg-authentication mb-0">
                                <div class="row m-0">
                                            ...
                                            <div class="card-header pb-1">
                                                <div class="card-title">
                                                    <h4 class="text-center mb-2">
                                                        {{ trans('backLang.signedInToControl') }}</h4>
                                                </div>
                                            </div>
                                                        ...
                                                        <form name="form" method="POST"
                                                            ...
                                                            <div
                                                                ...
                                                                <input type="email" name="email"
                                                                    value="{{ old('email') }}" class="md-input"
                                                                    required>
                                                            ...
                                                            <div class="m-b-md">
                                                                <label class="md-check">
                                                                    <input type="checkbox" name="remember"><i
                                                                        class="primary"></i>
                                                                    {{ trans('backLang.keepMeSignedIn') }}
                                                                </label>

                                                            </div>
                                                            <button type="submit"
                                                                class="btn primary btn-block p-x-md">{{ trans('backLang.signIn') }}</button>
                                                        </form>
                                                        @if (Helper::GeneralWebmasterSettings('register_status'))
                                                            <br>
                                                            <div class="text-center">
                                                                <a href="{{ url('/register') }}"
                                                                    class="btn info btn-block p-x-md"><i
                                                                        class="material-icons">&#xe7fe;</i>
                                                                    {{ trans('backLang.createNewAccount') }}
                                                                </a>
                                                            </div>
                                                        @endif
                                                    </div>
                                                    ...
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="p-v-lg btn-block text-left">
                                                            <div class="m-b"><a href="{{ url('/password/reset') }}"
                                                                    class="text-primary _600">{{ trans('backLang.forgotPassword') }}</a>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="col-md-6 d-md-block d-none text-center align-self-center p-3">
                                        <div class="card-content">
                                            <img class="img-fluid" src="{{ asset('plugins/auto/img/login.png') }}"
                                                alt="branding logo">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-md-6 d-md-block d-none text-center align-self-center p-3">
                    <div class="card-content">
                        <img class="img-fluid" src="{{ asset('plugins/auto/img/login.png') }}" alt="branding logo">
                    </div>
                </div>
            </div>
        </div>
