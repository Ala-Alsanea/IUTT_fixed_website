            ...
            <div class="mm-pos">
              <div class="{!! $HeaderMenuLink->link !!}-mm m-menu">
                   <div class="m-menu-inn row">
                      ...
                      ?>
                        <div class="mm1-com mm1-s1 col-xl-{{ $col }} col-lg-{{ $col }} col-md-{{ $col }} col-sm-6 col-xs-12 ">
                         ...
                         @foreach($subMenus->subMenus as $keys=> $subMenusFilnal)
                               @if($subMenusFilnal->status==1)
                                 @if($HeaderMenuLink->link=='admi' && $keys==$subMenus->subMenus->count()-1)
                                     <li><a  class="mm-r-m-btn-cust btn_m" href="{{ url(trans('backLang.code').'/'.$subMenusFilnal->link) }}">{{ $subMenusFilnal->$link_title_var }}</a></li>
