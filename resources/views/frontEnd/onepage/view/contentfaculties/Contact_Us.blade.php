      ...
      <div class="main-detail main-detail-10"     style="display: none;">
    <style type="text/css"
>
  label ,.label{
    /* font-size: 13px; */
    ...
    /* border: 1px solid #ccc; */
              ...
              <div class="printable-version" style="background-color: #fff; padding: 10px;">
                      <div class="contact-us row" style="  background-image: url({{ Helper::getBannerStatic('Banner_faculity_page_contactus_bg') }});    background-size: 100%;    background-position: bottom;  padding-top: 20px;  margin: -20px;  padding-bottom: 50px;">
