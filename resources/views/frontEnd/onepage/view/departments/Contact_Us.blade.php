      <div class="main-detail main-detail-6"     style="display: none;">
              ...
              <div class="printable-version" style=" padding: 10px;">
                      <div class="contact-us row" style="background-color: #141c33;" >
                        ...
                        @if(Helper::GeneralSiteSettings("contact_t5") !="")
                            <p>
                                ...
                                <span
                                        dir="ltr"><a href="tel:{{ Helper::GeneralSiteSettings("contact_t5") }}">{{ Helper::GeneralSiteSettings("contact_t5") }} </span>
                            </p>
                        @endif
...
<br>
            ...
            <br>
                        ...
                        <!---------------------------------------------------------------------------------------------->
   {{Form::open(['route'=>['contactPage'],'method'=>'POST','class'=>'contactForm row','id'=>'contactForm'])}}
