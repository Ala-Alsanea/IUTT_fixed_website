    ...
    <div class="wrapper clear">
        <div class="main-image-tab-2 clear">
           ...
           <a href="javascript:void();">
                <div class="option  option-1 active" data-id="1" style="background:url({{ Helper::FilterImage($BannerOverView) }}) no-repeat center center; background-size:cover;">
            ...
            ?>
              ...
              <a href="javascript:void();">
                <div class="option  option-2 " data-id="2" style="background:url({{ Helper::FilterImage($BannerVisonM) }}) no-repeat center center; background-size:cover;">
            ...
            ?>
   <a href="javascript:void();">
                <div class="option option-3" data-id="3" style="background:url({{ Helper::FilterImage($Bannerdeansmessage) }}) no-repeat center center; background-size:cover;">
                    <span class="People">{{ trans('frontLang.deansmessage') }}</span>
                </div>
            </a>
              <a href="javascript:void();">
                <div class="option option-4" data-id="4" style="background:url({{ Helper::FilterImage($backgroundImagedeanship) }}) no-repeat center center; background-size:cover;">
                    <span class="People">{{ trans('frontLang.deanship') }}</span>
                </div>
            </a>
            ...
            ?>
              <a href="javascript:void();">
                <div class="option option-5" data-id="5" style="background:url({{ Helper::FilterImage($BannercontentHighlights) }}) no-repeat center center; background-size:cover;">
                    <span class="departments">{{ trans('frontLang.highlights') }}</span>
                </div>
            </a>
            @endif
            ...
            ?>
            <a href="javascript:void();">
                <div class="option option-6" data-id="6" style="background:url({{ Helper::FilterImage($Bannercoursedescriptions) }}) no-repeat center center; background-size:cover;">
                    <span class="departments">{{ trans('frontLang.coursedescriptions') }}</span>
                </div>
            </a>
             @endif
              <?php
            ...
            ?>
        @if(!empty($contentAcademicPlan))
            <a href="javascript:void();">
                <div class="option option-7" data-id="7" style="background:url({{ Helper::FilterImage($BannercontentAcademicPlan) }}) no-repeat center center; background-size:cover;">
                    <span class="departments">{{ trans('frontLang.AcademicPlan') }}</span>
                </div>
            </a>
            @endif
           <a href="javascript:void();">
                <div class="option option-8" data-id="8" style="background:url({{ Helper::FilterImage($deparmentsImage) }}) no-repeat center center; background-size:cover;">
            ...
            <div class="first-row">
                <h2 class="title title-1 active about" style="display: block;">{{ trans('frontLang.Overview') }}</h2>
                   <h2 class="title title-2  about" style="display: none;">{{ trans('frontLang.Vision_Mission') }}</h2>
                      ...
                      <h2 class="title title-3 deansmessage" style="display: none;">{{ trans('frontLang.deansmessage') }}</h2>
