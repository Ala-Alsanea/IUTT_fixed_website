    ...
    /* border: 1px solid #ccc; */
      ...
      <div class="main-detail main-detail-6"     style="display: none;">
              ...
              <div class="printable-version" style="background-color: #fff; padding: 10px;">
                      <div class="contact-us fixfont row"    style="  background-image: url({{ Helper::getBannerStatic('Banner_centers_page_contactus_bg') }});    background-size: 100%;    background-position: bottom;  padding-top: 20px;  margin: -20px;  padding-bottom: 50px;">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 new-con new-con3"> 
                           <br>
                               @if($universitycenter->mobile!="")
                            <p>
                                <i class="fa fa-phone"></i>
                                <strong>{{ trans('frontLang.callMobile') }}:</strong> 
                                <span
                                        dir="ltr"><a href="tel:{{ $universitycenter->mobile }}">{{ $universitycenter->mobile }} </a></span>
                            </p>
                        @endif

                        @if($universitycenter->phone !="")
                            <p>
                                <i class="fa fa-phone"></i>
                                <strong>{{  trans('frontLang.callPhone') }}:</strong> 
                                <span
                                        dir="ltr"><a href="tel:{{ $universitycenter->phone }}">{{ $universitycenter->phone }}</a></span>
                            </p>
                        @endif
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 new-con new-con4"> <img src="img/contact/3.png" alt="">
                              <br>
                          @if($universitycenter->fax !="")
                            <p>
                                <i class="fa fa-fax"></i>
                                <strong>{{ trans('frontLang.callFax') }}:</strong> 
                                <span
                                        dir="ltr"><a href="tel:{{ $universitycenter->fax }}">{{ $universitycenter->fax }} </a></span>
                            </p>
                        @endif
                        @if($universitycenter->email !="")
                            <p>
                                <i class="fa fa-envelope"></i>
                                <strong>{{ trans('frontLang.email') }}:</strong>
                                <a href="mailto:{{ $universitycenter->email }}">{{ $universitycenter->email }}</a>
                            </p>
                        @endif
...
<br>
            ...
            <br>
                        ...
                        <!---------------------------------------------------------------------------------------------->
   {{Form::open(['route'=>['CenterPageSubmit',$universitycenter->id],'method'=>'POST','class'=>'contactForm row'])}}
