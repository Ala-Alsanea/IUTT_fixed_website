                            ...
                            @foreach ($FatherMenus as $FatherMenu)
                                ...
                                ?>
                                  <?php
                                   ...
                                   $ParentSubMenuId=$FatherMenu->id;

                                  $FatherSubMenus=App\Models\Menu::where('father_id', $ParentSubMenuId)->where('type', 0)->orderby('row_no', 'asc')->get();



                                ?>
                                   <option value="{{ $FatherMenu->id  }}" {{ ($FatherMenu->id == $Menus->father_id) ? "selected='selected'":""  }} class="parentmenu">{{ $title }}</option>
                                @if(count((array)$FatherSubMenus)>0)
                             
                               
                                  
                               
                                 @foreach ($FatherSubMenus as $SubMenu)
                                   
                                 <?php
                                if ($SubMenu->$title_var != "") {
                                    $titles= $SubMenu->$title_var;
                                } else {
                                    $titles= $SubMenu->$title_var2;
                                }
                                ?>
                                  <?php
                                  ...
                                  $FatherSubMenus_l=App\Models\Menu::where('father_id', $ParentSubMenuId)->where('type', 0)->orderby('row_no', 'asc')->get();



                                ?>

                           <option value="{{ $SubMenu->id  }}" {{ ($SubMenu->id == $Menus->father_id) ? "selected='selected'":""  }} class="childmenu">{{ $titles }}</option>
