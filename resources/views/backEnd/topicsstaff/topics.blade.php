...
$listRelatdFaculty=array('facultiesslider','fstudents','departments','sitePages','section_quik_icon','academicstaff','contentprograms','lecturertable','contentsdepartment','contentscenters');
  $existfaculty=false;
...
$contentNameOfField="";
            ...
            if ($WebmasterSection->name=='contentsdepartment') {
              $webmaster_id=22;
               ...
               $webmaster_id=15;
               $titleLable=trans('backLang.universitycentersfaculty');
             }
        ...
        <div class="box">
            ...
            @if($Topics->total() >0)
                @if(@Auth::user()->permissionsGroup->add_status)
                    <div class="row p-a">
                        <div class="col-sm-12">
                            <a class="btn btn-fw primary" href="{{route("topicsstaffCreate",[$WebmasterSection->id,$section_id])}}">
           ...
           <?php 
                                ...
                                ?>
            @if($Topics->total() > 0)
                {{Form::open(['route'=>['topicsstaffUpdateAll',$WebmasterSection->id,$section_id],'method'=>'post'])}}
                        ...
                        @foreach($Topics as $Topic)
                            ...
                            if ($WebmasterSection->sections_status != 0) {
                                ...
                                if ($section == "") {
                                    ...
                                    $section =  "<span style='color: blue'>".trans('backLang.group')."<i>[" . rtrim($section, ", ") . "]</i></span>";
                                }
                            }
                          $refrencetopiccontent="";
                             if ($Topic->refrence_id != 0) {
                                
                                 $refrencetopiccontent = "<span style='color:blue'>".$Topic->refrencetopic->$title_var ."</span>";

                                }
                                  $facultyopiccontent = "";
                                  
                             if ($Topic->father_id != 0) {
                                   $facultyopiccontent = "<span style='color: green'><i>" . $titleLable . "</i>:".$Topic->father->$title_var."</span>";
                                    ...
                                    <div>
                                        ...
                                        <small>
                                         ...
                                         <small>
                                              ...
                                              @include('backEnd.topicsstaff.parts.partCustomFields')
                                         </small>
                                ...
                                <td class="text-center">
                                    @if(@Auth::user()->permissionsGroup->edit_status)
                                        <a class="btn btn-sm success"
                                           href="{{ route("topicsstaffEdit",["webmasterId"=>$WebmasterSection->id,"section_id"=>$section_id,"id"=>$Topic->id]) }}">
                                ...
                                <div class="modal-dialog" id="animate">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ route("topicsstaffDestroy",["webmasterId"=>$WebmasterSection->id,'section_id'=>$section_id,"id"=>$Topic->id]) }}"
