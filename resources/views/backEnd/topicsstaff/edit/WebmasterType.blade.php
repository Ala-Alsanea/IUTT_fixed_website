    ...
    <div id="files_div" style="display: {{ ($Topics->video_type ==0) ? "block" : "none" }}">
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                @if($Topics->video_type==0 && $Topics->video_file!="")
                    <div class="box p-a-xs">
                        ...
                        <video width="380" height="230" controls>
                            <source src="{{ Helper::FilterImage($Topics->video_file) }}"
                                    type="video/mp4">
                            Your browser does not support the video tag.
                        </video>
                        <br>
                        <a target="_blank"
                           href="{{ Helper::FilterImage($Topics->video_file) }}">
                            {{ $Topics->video_file }} </a>
                    </div>
                @endif
             ...
             {!! Form::text('video_file',$Topics->video_file, array('placeholder' => '','class' => 'form-control','id'=>'video_file')) !!}
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            @if($Topics->audio_file!="")
                <div class="box p-a-xs">
                    <audio controls>
                        <source src="{{ Helper::FilterImage($Topics->audio_file) }}"
                                type="audio/mpeg">
                        Your browser does not support the audio element.
                    </audio>
                    <br>
                    <a target="_blank"
                       href="{{ Helper::FilterImage($Topics->audio_file) }}"> {{ $Topics->audio_file }} </a>
                </div>
            @endif
             ...
             {!! Form::text('audio_file',$Topics->audio_file, array('placeholder' => '','class' => 'form-control','id'=>'audio_file')) !!}
...
<div class="form-group row">
    ...
    <div class="col-sm-10">
        ...
        {!! Form::text('photo_file',$Topics->photo_file, array('placeholder' => '','class' => 'form-control','id'=>'photo_file','required'=>'')) !!}
        ...
        <div class="col-sm-10">
            @if($Topics->attach_file!="")
                <div id="topic_attach" class="col-sm-4 box p-a-xs">
                    <a target="_blank"
                           href="{{Helper::FilterImage($Topics->attach_file) }}"><img
                                    src="{{Helper::FilterImage($Topics->attach_file) }}"
