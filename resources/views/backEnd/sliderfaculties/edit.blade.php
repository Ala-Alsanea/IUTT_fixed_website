        ...
        <div class="box m-b-0">
            <div class="box-header dker">
                <h3><i class="material-icons">
                        &#xe3c9;</i> {{ trans('backLang.topicEdit') }} {!! trans('backLang.sliderfaculties') !!}
                </h3>
                <small>
            ...
            <div class="box-tool">
                <ul class="nav">
                    <li class="nav-item inline">
                        <a class="nav-link" href="{{ route('sliderfaculties') }}">
                            ...
                            <div class="col-sm-10">
                                <div class="radio">
                                    <label class="ui-check ui-check-md">
                                        {!! Form::radio('status','1',($sliderfaculties->status==1) ? true : false, array('id' => 'status1','class'=>'has-value')) !!}
                                        <i class="dark-white"></i>
                                        {{ trans('backLang.active') }}
                                    </label>
                                    &nbsp; &nbsp;
                                    <label class="ui-check ui-check-md">
                                        {!! Form::radio('status','0',($sliderfaculties->status==0) ? true : false, array('id' => 'status2','class'=>'has-value')) !!}
                                        <i class="dark-white"></i>
    ...
    <script>
        ...
        $("#seo_title_ar").on('keyup change', function () {
            if ($(this).val() != "") {
                ...
                $("#title_in_engines_ar").text("<?php echo $sliderfaculties->title_ar; ?>");
            }
        });
        ...
        $("#seo_title_en").on('keyup change', function () {
            if ($(this).val() != "") {
                ...
                $("#title_in_engines_en").text("<?php echo $sliderfaculties->title_en; ?>");
            }
        });
