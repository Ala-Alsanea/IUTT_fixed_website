...
.contentPrivligebox .checkbox .material-icons.add{
    ...
    <div class="padding">
        <div class="box">
            ...
            <div class="box-body">
                {{Form::open(['route'=>['Update',$Permissions->id],'method'=>'POST'])}}
                ...
                ?>
                   ...
                   <div class="form-group row">
                      <?php 
                         ...
                         $PageDetail= App\Models\PermissionsPage::where('Permission_id',$Permission_id)->where('Page_id',$Page_id)->orderby('Id', 'asc')->get();
                      $PermissionsPageId=0;
                         $SelectedPage=0;
                         if (count($PageDetail)>0) {
                            $PermissionsPageId=$PageDetail[0]->Id;
                              $SelectedPage=$PageDetail[0]->Page_id;
                         }
              ...
              @if(count($SubMenus)==0)
                     ...
                     <div class="checkbox">
                            <label class="ui-check">
                             @if($MainMenu->CatType==2)
                                ...
                                {!! Form::checkbox('MenuSection[]',$Page_id,($SelectedPage!=0) ? true : false, array('id' =>'MenuSection'.$MainMenu->Cat_id)) !!}
                ...
                @endif
                 ...
                 <div class="col-sm-10">
                     ...
                     $SubSelectedPage=0;
                         if (count($PageDetail)>0) {
                            $SubSelectedPage=$PageDetail[0]->Page_id;
                         }
                        ...
                        <div class="checkbox">
                            <label class="ui-check">
                                @if($SubMenu->CatType==2)
                                 ...
                                 @endif
                                {!! Form::checkbox('MenuSection[]',$Page_id,($SubSelectedPage!=0) ? true : false, array('id' =>'MenuSection'.$SubMenu->Cat_id)) !!}
                                <i class="dark"></i><label
