    ...
    <div class="padding">
        <div class="app-body-inner">
            <div class="row-col row-col-xs">
                <!-- column -->
                <div class=" col-sm-2 col-md-2 col-xl-2 col-lg-2 w w-auto-sm b-r">
                    <div class="row-col">
                        <div class="row-row">
                            <div class=" hover">
                                <div class="row1">
                ...
                <ul class="list">
                    ...
                    @foreach($ContactsGroups as $ContactsGroup)
                        <li class="marginBottom5"
                            ...
                            <a href="{{ route("contacts",["group_id"=>$ContactsGroup->id]) }}" {!!   ($ContactsGroup->id == $group_id) ? " style='font-weight: bold;color:#0cc2aa'":""  !!} >
                {!! $ContactsGroup->name !!}
