    ...
    <div class="padding">
        <div class="box m-b-0">
            <div class="box-header dker">
                <h3><i class="material-icons">
                        &#xe3c9;</i> {{ trans('backLang.topicEdit') }} {!! trans('backLang.contentfaculties') !!}
                </h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ trans('backLang.home') }}</a> /
                    <a>{!! trans('backLang.contentfaculties') !!}</a>
                </small>
            </div>
            <div class="box-tool">
                <ul class="nav">
                    <li class="nav-item inline">
                        <a class="nav-link" href="{{ route('contentfaculties') }}">
        ...
        <div class="box nav-active-border b-info">
            <ul class="nav nav-md">
                 ...
                 @include('backEnd.contentfaculties.edit.WebmastersNavTab')
       ...
       <div class="tab-pane  {{ $tab_1 }}" id="tab_details">
                    <div class="box-body">
                        {{Form::open(['route'=>['contentfacultiesUpdate',"id"=>$contentsections->id],'method'=>'POST', 'files' => true])}}



           {{--      @include('backEnd.contentfaculties.edit.WebmasterDate') --}}
                @include('backEnd.contentfaculties.edit.WebmasterContent')
       ...
       @include('backEnd.contentfaculties.edit.WebmastersSeo')
