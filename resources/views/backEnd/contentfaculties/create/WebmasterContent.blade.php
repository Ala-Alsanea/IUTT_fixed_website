...
<div class="form-group row m-t-md hidden" style="margin-top: 0 !important;">
 ...
 <select name="catagoryes" id="catagoryes" class="form-control " required
         ...
         <option value="2">{{ trans('frontLang.Vision_Mission')  }}</option>   
           <option value="3">{{ trans('frontLang.deansmessage')  }}</option>
 <option value="4">{{ trans('frontLang.coursedescriptions')  }}</option>
 <option value="5" >{{ trans('frontLang.AcademicPlan')  }}</option> 
 <option value="6">{{ trans('frontLang.highlights')  }}</option>
