 <div class="tab-pane  {{ $tab_1 }}" id="tab_details">
                    <div class="box-body">
                        {{Form::open(['route'=>['staffUpdate',"section_id"=>$section_id,"id"=>$Topics->id],'method'=>'POST', 'files' => true])}}



                @include('backEnd.staff.edit.WebmasterContent')
