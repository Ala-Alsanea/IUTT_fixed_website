    ...
    <div class="padding">
        <div class="box m-b-0">
            <div class="box-header dker">
                <h3><i class="material-icons">
                        &#xe3c9;</i> {{ trans('backLang.topicEdit') }} {!! trans('backLang.contentscenters') !!}
                </h3>
                <small>
            ...
            <div class="box-tool">
                <ul class="nav">
                    <li class="nav-item inline">
                        <a class="nav-link" href="{{ route('contentscenters') }}">
        ...
        <div class="box nav-active-border b-info">
            <ul class="nav nav-md">
                 ...
                 @include('backEnd.contentscenters.edit.WebmastersNavTab')
       ...
       <div class="tab-pane  {{ $tab_1 }}" id="tab_details">
                    <div class="box-body">
                        {{Form::open(['route'=>['contentscentersUpdate',"id"=>$contentsections->id],'method'=>'POST', 'files' => true])}}



           {{--      @include('backEnd.contentscenters.edit.WebmasterDate') --}}
                @include('backEnd.contentscenters.edit.WebmasterContent')
       ...
       @include('backEnd.contentscenters.edit.WebmastersSeo')
