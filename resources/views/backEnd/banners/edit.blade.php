...
@section('content')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    @if($Banners->file_ar!="")
                                     ...
                                     {!! Form::text('file_ar',$Banners->file_ar, array('placeholder' => '','class' => 'form-control','id'=>'file_ar','required'=>'')) !!}
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="col-sm-4 box p-a-xs">
                        <a target="_blank"
                           href="{{ Helper::FilterImage($Banners->file_ar) }}" class="fancybox" id="link-file_ar">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    @if($Banners->file_en!="")
                                     ...
                                     {!! Form::text('file_en',$Banners->file_en, array('placeholder' => '','class' => 'form-control','id'=>'file_en','required'=>'')) !!}
                                            <div class="row">
                        <div class="col-sm-12">
                            <div class="col-sm-4 box p-a-xs">
                                <a target="_blank"
                                   href="{{ Helper::FilterImage($Banners->file_en) }}">
                                   <img
                                            src="{{ Helper::FilterImage($Banners->file_en) }}"
                                            class="img-responsive  file_en groupMediaPhoto">
                                   {{  $Banners->file_en }}
                                </a>
                            </div>
                        </div>
                                        ...
                                        @else
                                            <a target="_blank"
                                               href="{{ Helper::FilterImage($Banners->file_en) }}">{!!  $Banners->file_en !!}</a>
                                        @endif
                                    @endif
 ...
 <div class="form-group row">
                        <label for="icon"
                               class="col-sm-2 form-control-label">{!!  trans('backLang.BannerKey') !!}</label>
                        <div class="col-sm-10">
                            <div class="input-group">
                                {!! Form::text('BannerKey',$Banners->BannerKey, array('placeholder' => '','class' => 'form-control','id'=>'BannerKey')) !!}
                                <span class="input-group-addon"></span>
                            </div>
                        </div>
                    </div>
