...
@section('content')
    <div class="padding">
                        ...
                        @if (Session::has('fieldST'))
                            ...
                            <div class="form-group row">
                                            <label for="field_name"
                                                   class="col-sm-2 form-control-label">{!!  trans('backLang.field_name') !!}
                                                @if(Helper::GeneralWebmasterSettings("ar_box_status") && Helper::GeneralWebmasterSettings("en_box_status")){!!  trans('backLang.arabicBox') !!}@endif
                                            </label>
                                            <div class="col-sm-10">
                                                {!! Form::text('field_name','', array('placeholder' => '','class' => 'form-control','id'=>'field_name','required'=>'', 'dir'=>trans('backLang.rtl'))) !!}
                                            </div>
                                        </div>
      ...
      <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                {!! Form::text('field_name',Session::get('WebmasterSectionField')->field_name, array('placeholder' => '','class' => 'form-control','id'=>'field_name','required'=>'', 'dir'=>trans('backLang.rtl'))) !!}
                                            </div>
                                        </div>
