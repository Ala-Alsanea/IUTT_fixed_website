    ...
    <div class="padding">
        <div class="box">
            <div class="box-header dker">
                <h3>{!! trans('backLang.contentdepartments') !!}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ trans('backLang.home') }}</a> /
                    <a>{!! trans('backLang.contentdepartments') !!}</a>
                </small>
            </div>
            @if($contentsections->total() >0)
                @if(@Auth::user()->permissionsGroup->add_status)
                    <div class="row p-a">
                        <div class="col-sm-12">
                        <a class="btn btn-fw primary" href="{{route("contentdepartmentsCreate")}}">
                                <i class="material-icons">&#xe02e;</i>
                                &nbsp; {{ trans('backLang.topicNew') }}  {!! trans('backLang.contentdepartments') !!}
                            </a>
                        </div>
                    </div>
                @endif
           ...
           <?php 
                                ...
                                ?>
            @if($contentsections->total() > 0)
                {{Form::open(['route'=>['contentdepartmentsUpdateAll'],'method'=>'post'])}}
                    ...
                    <table class="table table-striped  b-t">
                        ...
                        <tr>
                            ...
                            <th>{{ trans('backLang.topicName') }}</th>
                               <th>{{ trans('backLang.departments') }}</th>
                               <th>{{ trans('backLang.faculty') }}</th>
                            ...
                            <tr>
                               ...
                               <td class="text-center">
                                 ...
                                 <td class="text-center">
                                  ...
                                  <?php 
                        $department=App\Models\Department::find($Topic->father_id);
                                if (count((array)$department)>0) {
                                     echo $department->$title_var;
                                }
                                  ?>
                                ...
                                <td class="text-center">
                                    @if(@Auth::user()->permissionsGroup->edit_status)
                                        <a class="btn btn-sm success"
                                           href="{{ route("contentdepartmentsEdit",["id"=>$Topic->id]) }}">
                                ...
                                <div class="modal-dialog" id="animate">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ route("contentdepartmentsDestroy",["id"=>$Topic->id]) }}"
