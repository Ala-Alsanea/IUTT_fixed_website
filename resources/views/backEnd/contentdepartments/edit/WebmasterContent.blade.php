...
@if(Helper::GeneralWebmasterSettings("ar_box_status"))
 ...
 <div class="form-group row">
    ...
    <div class="col-sm-10">
        ...
        {!! Form::text('photo_file',$contentsections->photo_file, array('placeholder' => '','class' => 'form-control','id'=>'photo_file')) !!}
 ...
 <option value="3" {{ ($contentsections->catagoryes==3)?'selected':'' }}>{{ trans('frontLang.coursedescriptions')  }}</option>
 <option value="4"  {{ ($contentsections->catagoryes==4)?'selected':'' }}>{{ trans('frontLang.AcademicPlan')  }}</option>

  <option value="5" {{ ($contentsections->catagoryes==5)?'selected':'' }}>{{ trans('frontLang.departmentInf')  }}</option>
 <option value="6" {{ ($contentsections->catagoryes==6)?'selected':'' }}>{{ trans('frontLang.Departmentheadword')  }}</option>
