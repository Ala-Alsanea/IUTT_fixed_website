    ...
    <div class="padding">
        <div class="box m-b-0">
            <div class="box-header dker">
                <h3><i class="material-icons">
                        &#xe3c9;</i> {{ trans('backLang.topicEdit') }} {!! trans('backLang.contentdepartments') !!}
                </h3>
                <small>
            ...
            <div class="box-tool">
                <ul class="nav">
                    <li class="nav-item inline">
                        <a class="nav-link" href="{{ route('contentdepartments') }}">
        ...
        <div class="box nav-active-border b-info">
            <ul class="nav nav-md">
                 ...
                 @include('backEnd.contentdepartments.edit.WebmastersNavTab')
       ...
       <div class="tab-pane  {{ $tab_1 }}" id="tab_details">
                    <div class="box-body">
                        {{Form::open(['route'=>['contentdepartmentsUpdate',"id"=>$contentsections->id],'method'=>'POST', 'files' => true])}}



           {{--      @include('backEnd.contentdepartments.edit.WebmasterDate') --}}
                @include('backEnd.contentdepartments.edit.WebmasterContent')
                            ...
                            <div class="col-sm-10">
                                <div class="radio">
                                    <label class="ui-check ui-check-md">
                                        {!! Form::radio('status','1',($contentsections->status==1) ? true : false, array('id' => 'status1','class'=>'has-value')) !!}
                                        <i class="dark-white"></i>
                                        {{ trans('backLang.active') }}
                                    </label>
                                    &nbsp; &nbsp;
                                    <label class="ui-check ui-check-md">
                                        {!! Form::radio('status','0',($contentsections->status==0) ? true : false, array('id' => 'status2','class'=>'has-value')) !!}
                                        <i class="dark-white"></i>
                        ...
                        <div class="form-group row m-t-md">
                            <div class="col-sm-offset-2 col-sm-10">
                                ...
                                <a href="{{ route('contentdepartments') }}"
       ...
       @include('backEnd.contentdepartments.edit.WebmastersSeo')
    ...
    <script>
        ...
        $("#seo_title_ar").on('keyup change', function () {
            if ($(this).val() != "") {
                ...
                $("#title_in_engines_ar").text("<?php echo $contentsections->title_ar; ?>");
            }
        });
        ...
        $("#seo_title_en").on('keyup change', function () {
            if ($(this).val() != "") {
                ...
                $("#title_in_engines_en").text("<?php echo $contentsections->title_en; ?>");
            }
        });
            ...
            $(document).ready(function () {
                $.ajax({
                    ...
                    success: function (data) {
                        $('#r_contentdepartments').html(data)
                    }
                }); //End of Ajax
            });
