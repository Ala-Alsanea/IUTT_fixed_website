    ...
    <div class="padding">
        <div class="box">
            <div class="box-header dker">
                <h3>{!! trans('backLang.students') !!}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ trans('backLang.home') }}</a> /
                    <a>{!! trans('backLang.students') !!}</a>
                </small>
            </div>
            @if($students->total() >0)
                @if(@Auth::user()->permissionsGroup->add_status)
                    <div class="row p-a">
                        <div class="col-sm-12">
                        <a class="btn btn-fw primary" href="{{route("studentsCreate")}}">
                                <i class="material-icons">&#xe02e;</i>
                                &nbsp; {{ trans('backLang.topicNew') }}  {!! trans('backLang.students') !!}
                            </a>
                        </div>
                    </div>
                @endif
           ...
           <?php 
                                ...
                                ?>
            @if($students->total() > 0)
                {{Form::open(['route'=>['studentsUpdateAll'],'method'=>'post'])}}
                                ...
                                <td class="text-center">
                                    @if(@Auth::user()->permissionsGroup->edit_status)
                                        <a class="btn btn-sm success"
                                           href="{{ route("studentsEdit",["id"=>$Topic->id]) }}">
                                ...
                                <div class="modal-dialog" id="animate">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ route("studentsDestroy",["id"=>$Topic->id]) }}"
                ...
                <footer class="dker p-a">
                    <div class="row">
                        ...
                        <div class="col-sm-3 text-center">
                            <small class="text-muted inline m-t-sm m-b-sm">{{ trans('backLang.showing') }} {{ $students->firstItem() }}
                                -{{ $students->lastItem() }} {{ trans('backLang.of') }}
                                <strong>{{ $students->total()  }}</strong> {{ trans('backLang.records') }}</small>
                        </div>
