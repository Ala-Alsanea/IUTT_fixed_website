        ...
        <div class="box">
            <div class="box-header dker">
                <h3><i class="material-icons">
                        &#xe02e;</i> {{ trans('backLang.topicNew') }} {!! trans('backLang.students') !!}
                </h3>
                <small>
            ...
            <div class="box-body">
                {{Form::open(['route'=>['studentsStore'],'method'=>'POST', 'files' => true ])}}


            {{--     @include('backEnd.students.create.WebmasterDate')  --}}
                @include('backEnd.students.create.WebmasterContent')
