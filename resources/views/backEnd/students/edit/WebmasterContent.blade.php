 ...
 $faculties=App\Models\Faculty::where('status', 1)->orderby('row_no', 'asc')->get();
        ...
        @foreach ($faculties as $facultiy)
            ...
            ?>
               <option value="{{ $facultiy->id  }}" {{ ($facultiy->id==$students->faculty_id) ? "selected='selected'":""  }}>{{ $ftitle }}</option>
...
@if(Helper::GeneralWebmasterSettings("ar_box_status"))
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                {!! Form::text('title_ar',$students->title_ar, array('placeholder' => '','class' => 'form-control','id'=>'title_ar','required'=>'', 'dir'=>trans('backLang.rtl'))) !!}
            </div>
        </div>
    @endif
    @if(Helper::GeneralWebmasterSettings("en_box_status"))
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                {!! Form::text('title_en',$students->title_en, array('placeholder' => '','class' => 'form-control','id'=>'title_en','required'=>'', 'dir'=>trans('backLang.ltr'))) !!}
            </div>
        </div>
    @endif
 ...
 <div class="form-group row ">
    ...
    <div class="col-sm-10">
        ...
        {!! Form::text('photo_file',$students->photo_file, array('placeholder' => '','class' => 'form-control','id'=>'photo_file','required'=>'')) !!}
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div id="topic_photo" class="col-sm-4 box p-a-xs">
                        ...
                        <a target="_blank"
                           href="{{Helper::FilterImage($students->photo_file) }}"><img
                                    src="{{Helper::FilterImage($students->photo_file) }}"
