    ...
    <div class="padding">
        <div class="box m-b-0">
            <div class="box-header dker">
                <h3><i class="material-icons">
                        &#xe3c9;</i> {{ trans('backLang.topicEdit') }} {!! trans('backLang.students') !!}
                </h3>
                <small>
        ...
        <div class="box nav-active-border b-info">
            <ul class="nav nav-md">
                 ...
                 @include('backEnd.students.edit.WebmastersNavTab')
       ...
       <div class="tab-pane  {{ $tab_1 }}" id="tab_details">
                    <div class="box-body">
                        {{Form::open(['route'=>['studentsUpdate',"id"=>$students->id],'method'=>'POST', 'files' => true])}}



           {{--      @include('backEnd.students.edit.WebmasterDate') --}}
                @include('backEnd.students.edit.WebmasterContent')
                            ...
                            <div class="col-sm-10">
                                <div class="radio">
                                    <label class="ui-check ui-check-md">
                                        {!! Form::radio('status','1',($students->status==1) ? true : false, array('id' => 'status1','class'=>'has-value')) !!}
                                        <i class="dark-white"></i>
                                        {{ trans('backLang.active') }}
                                    </label>
                                    &nbsp; &nbsp;
                                    <label class="ui-check ui-check-md">
                                        {!! Form::radio('status','0',($students->status==0) ? true : false, array('id' => 'status2','class'=>'has-value')) !!}
                                        <i class="dark-white"></i>
    ...
    <script>
        ...
        $("#seo_title_ar").on('keyup change', function () {
            if ($(this).val() != "") {
                ...
                $("#title_in_engines_ar").text("<?php echo $students->title_ar; ?>");
            }
        });
        ...
        $("#seo_title_en").on('keyup change', function () {
            if ($(this).val() != "") {
                ...
                $("#title_in_engines_en").text("<?php echo $students->title_en; ?>");
            }
        });
