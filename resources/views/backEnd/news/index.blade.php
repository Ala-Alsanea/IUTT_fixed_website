        ...
        <div class="box">
            ...
            @if($Topics->total() >0)
                @if(@Auth::user()->permissionsGroup->add_status)
                    <div class="row p-a">
                        <div class="col-sm-12">
                            <a class="btn btn-fw primary" href="{{route("topicsnewsCreate")}}">
           ...
           <?php 
                                ...
                                ?>
            @if($Topics->total() > 0)
                {{Form::open(['route'=>['topicsnewsUpdateAll'],'method'=>'post'])}}
                <div class="table-responsive">
                    <table class="table table-striped  b-t">
                        ...
                        <tr>
                            ...
                            <th>{{ trans('backLang.faculties') }}</th>
                        ...
                        @foreach($Topics as $Topic)
                          ...
                          $refrencetopiccontent="";
                           ...
                           <td class="text-center">
                                  @if($Topic->father_id>0)
                                  <?php 
                        $Faculty=App\Models\Faculty::find($Topic->father_id);
                                if (count((array)$Faculty)>0) {
                                     echo $Faculty->$title_var;
                                }
                                  ?>
