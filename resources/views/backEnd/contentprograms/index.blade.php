    ...
    <div class="padding">
        <div class="box">
            <div class="box-header dker">
                <h3>{!! trans('backLang.contentprograms') !!}</h3>
                <small>
            ...
            @if($contentsections->total() >0)
                @if(@Auth::user()->permissionsGroup->add_status)
                    <div class="row p-a">
                        <div class="col-sm-12">
                        <a class="btn btn-fw primary" href="{{route("contentprogramsCreate")}}">
                                <i class="material-icons">&#xe02e;</i>
                                &nbsp; {{ trans('backLang.topicNew') }}  {!! trans('backLang.contentprograms') !!}
                            </a>
                        </div>
                    </div>
                @endif
           ...
           <?php 
                                ...
                                ?>
            @if($contentsections->total() > 0)
                {{Form::open(['route'=>['contentprogramsUpdateAll'],'method'=>'post'])}}
                            ...
                            <tr>
                               ...
                               <td class="text-center">
                                 ...
                                 <td class="text-center">
                                  ...
                                  <?php 
                        $Program=App\Models\Program::find($Topic->father_id);
                                if (count((array)$Program)>0) {
                                     echo $Program->$title_var;
                                }
                                  ?>
                                ...
                                <td class="text-center">
                                    @if(@Auth::user()->permissionsGroup->edit_status)
                                        <a class="btn btn-sm success"
                                           href="{{ route("contentprogramsEdit",["id"=>$Topic->id]) }}">
                                ...
                                <div class="modal-dialog" id="animate">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ route("contentprogramsDestroy",["id"=>$Topic->id]) }}"
