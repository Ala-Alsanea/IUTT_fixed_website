    ...
    <div class="padding">
        <div class="box m-b-0">
            <div class="box-header dker">
                <h3><i class="material-icons">
                        &#xe3c9;</i> {{ trans('backLang.topicEdit') }} {!! trans('backLang.contentprograms') !!}
                </h3>
                <small>
        ...
        <div class="box nav-active-border b-info">
            <ul class="nav nav-md">
                 ...
                 @include('backEnd.contentprograms.edit.WebmastersNavTab')
       ...
       <div class="tab-pane  {{ $tab_1 }}" id="tab_details">
                    <div class="box-body">
                        {{Form::open(['route'=>['contentprogramsUpdate',"id"=>$contentsections->id],'method'=>'POST', 'files' => true])}}



           {{--      @include('backEnd.contentprograms.edit.WebmasterDate') --}}
                @include('backEnd.contentprograms.edit.WebmasterContent')
       ...
       @include('backEnd.contentprograms.edit.WebmastersSeo')
