                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="box p-a-xs">
                            {!! Form::textarea('details_en',$Sections->details_en, array('ui-jp'=>'summernote','placeholder' => '','class' => 'form-control', 'dir'=>trans('backLang.ltr'),'ui-options'=>'{height: 300}')) !!}
                        </div>
                    </div>
                </div>
            @endif
        ...
        <div class="form-group row">
            <label for="photo"
                   class="col-sm-2 form-control-label">{!!  trans('backLang.bannerPhoto') !!}</label>
                       ...
                       {!! Form::text('photo',$Sections->photo, array('placeholder' => '','class' => 'form-control','id'=>'photo')) !!}
                                @if($Sections->photo!="")
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div id="section_photo" class="col-sm-4 box p-a-xs">
                                                <a target="_blank"
                                                   href="{{ Helper::FilterImage($Sections->photo) }}"><img
                                                            src="{{ Helper::FilterImage($Sections->photo) }}"
                                                            class="img-responsive photo groupMediaPhoto">
                                                    {{ $Sections->photo }}
                                                </a>
                                                <br>
   ...
   <div class="form-group row">
            <label for="banner"
                   class="col-sm-2 form-control-label">{!!  trans('backLang.banner') !!}</label>
                       ...
                       {!! Form::text('banner',$Sections->banner, array('placeholder' => '','class' => 'form-control','id'=>'banner')) !!}
                                @if($Sections->banner!="")
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div id="section_photo" class="col-sm-4 box p-a-xs">
                                                <a target="_blank"
                                                   href="{{ Helper::FilterImage($Sections->banner) }}"><img
                                                            src="{{ Helper::FilterImage($Sections->banner) }}"
                                                            class="img-responsive banner groupMediaPhoto">
                                                    {{ $Sections->banner }}
                                                </a>
                                                <br>
                                                <a onclick="document.getElementById('section_photo').style.display='none';document.getElementById('banner_delete').value='1';document.getElementById('undo').style.display='block';"
                                                   class="btn btn-sm btn-default">{!!  trans('backLang.delete') !!}</a>
                                            </div>
                                            <div id="undo" class="col-sm-4 p-a-xs" style="display: none">
                                                <a onclick="document.getElementById('section_photo').style.display='block';document.getElementById('banner_delete').value='0';document.getElementById('undo').style.display='none';">
                                                    <i class="material-icons">
                                                        &#xe166;</i> {!!  trans('backLang.undoDelete') !!}</a>
                                            </div>

                                            {!! Form::hidden('banner_delete','0', array('id'=>'photo_delete')) !!}
                                        </div>
                                    </div>
