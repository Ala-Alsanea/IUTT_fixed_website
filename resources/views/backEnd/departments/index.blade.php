    ...
    <div class="padding">
        <div class="box">
            <div class="box-header dker">
                <h3>{!! trans('backLang.departments') !!}</h3>
                <small>
            ...
            @if($Departments->total() >0)
                @if(@Auth::user()->permissionsGroup->add_status)
                    <div class="row p-a">
                        <div class="col-sm-12">
                        <a class="btn btn-fw primary" href="{{route("departmentsCreate")}}">
                                <i class="material-icons">&#xe02e;</i>
                                &nbsp; {{ trans('backLang.topicNew') }}  {!! trans('backLang.departments') !!}
                            </a>
                        </div>
                    </div>
                @endif
           ...
           <?php 
                                ...
                                ?>
            @if($Departments->total() > 0)
                {{Form::open(['route'=>['departmentsUpdateAll'],'method'=>'post'])}}
                        ...
                        @foreach($Departments as $Topic)
                            ...
                            <tr>
                               ...
                               <td class="text-center">
                                    {!! ($Topic->faculty)?$Topic->faculty->$title_var:'' !!}
                                ...
                                <td class="text-center">
                                    @if(@Auth::user()->permissionsGroup->edit_status)
                                        <a class="btn btn-sm success"
                                           href="{{ route("departmentsEdit",["id"=>$Topic->id]) }}">
                                ...
                                <div class="modal-dialog" id="animate">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ route("departmentsDestroy",["id"=>$Topic->id]) }}"
                ...
                <footer class="dker p-a">
                    <div class="row">
                        ...
                        <div class="col-sm-3 text-center">
                            <small class="text-muted inline m-t-sm m-b-sm">{{ trans('backLang.showing') }} {{ $Departments->firstItem() }}
                                -{{ $Departments->lastItem() }} {{ trans('backLang.of') }}
                                <strong>{{ $Departments->total()  }}</strong> {{ trans('backLang.records') }}</small>
                        </div>
