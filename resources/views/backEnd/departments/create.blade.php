        ...
        <div class="box">
            <div class="box-header dker">
                <h3><i class="material-icons">
                        &#xe02e;</i> {{ trans('backLang.topicNew') }} {!! trans('backLang.departments') !!}
                </h3>
                <small>
            ...
            <div class="box-body">
                {{Form::open(['route'=>['departmentsStore'],'method'=>'POST', 'files' => true ])}}


            {{--     @include('backEnd.departments.create.WebmasterDate')  --}}
                @include('backEnd.departments.create.WebmasterContent')
