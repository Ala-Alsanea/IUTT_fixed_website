        ...
        if ($menu_id > 0) {
            ...
            if (count((array)$Menu) > 0) {
                ...
                foreach ($Menu as $MenuLink) {
                    ...
                    $m_link = "";
                    $sub_count = count((array)$SubMenu);
                    if ($MenuLink->type == 3) {
                        // Section with drop list
                        $m_link = $MenuLink->webmasterSection->name;
                        $sub_count = count((array)$MenuLink->webmasterSection->sections);
        ...
        if ($group_id > 0) {
            ...
            if (count((array)$Banners) > 0) {
                ...
                $response = [
                    'msg' => 'List of Banners',
                    'type' => $type,
                    'banners_count' => count((array)$Banners),
            ...
            if (count((array)$Sections) > 0) {
                ...
                foreach ($Sections as $Section) {
                    ...
                    $response_details[] = [
                        ...
                        'sub_categories_count' => count((array)$SubSections),
                ...
                $response = [
                    ...
                    'type' => $type,
                    'categories_count' => count((array)$Sections),
            ...
            if (count((array)$Topics) > 0) {
                ...
                foreach ($Topics as $Topic) {
                    ...
                    foreach ($Topic->webmasterSection->customFields as $customField) {
                        ...
                        if (($cf_saved_val != "" || count((array)$cf_saved_val_array) > 0) && ($customField->lang_code == "all" || $customField->lang_code == "$lang")) {
                            $Additional_fields[] = [
                    ...
                    $response_details[] = [
                        ...
                        'visits' => $Topic->visits,
                        'href' => "topic/" . $Topic->id,
                        'fields_count' => count((array)$Additional_fields),
                        'fields' => $Additional_fields,
                        'Joined_categories_count' => count((array)$Topic->categories),
                ...
                $response = [
                    ...
                    'section_title' => $section_title,
                    'type' => $type,
                    'topics_count' => count((array)$Topics),
            ...
            if (count((array)$Topics) > 0) {
                ...
                foreach ($Topics as $Topic) {
                    ...
                    $response_details[] = [
                        ...
                        'fields_count' => count((array)$Additional_fields),
                        'fields' => $Additional_fields,
                        'Joined_categories_count' => count((array)$Joined_categories),
                        'Joined_categories' => $Joined_categories,
                        'photos_count' => count((array)$Photos),
                        'photos' => $Photos,
                        'attach_files_count' => count((array)$Attach_files),
                        'attach_files' => $Attach_files,
                        'maps_count' => count((array)$Maps),
                        'maps' => $Maps,
                        'comments_count' => count((array)$Comments),
                        'comments' => $Comments,
                        'related_topics_count' => count((array)$Related_topics),
        ...
        if ($topic_id > 0) {
            ...
            if (count((array)$Topics) > 0) {
                ...
                $response = [
                    ...
                    'photos_count' => count((array)$response_details),
        ...
        if ($topic_id > 0) {
            ...
            if (count((array)$Topics) > 0) {
                ...
                $response = [
                    ...
                    'topic_link' => "topic/" . $topic_id,
                    'topic_photo' => ($photo_file != "") ? url("") . "/uploads/topics/" . $photo_file : null,
                    'maps_count' => count((array)$response_details),
        ...
        if ($topic_id > 0) {
            ...
            if (count((array)$Topics) > 0) {
                ...
                $response = [
                    ...
                    'topic_link' => "topic/" . $topic_id,
                    'topic_photo' => ($photo_file != "") ? url("") . "/uploads/topics/" . $photo_file : null,
                    'files_count' => count((array)$response_details),
        ...
        if ($topic_id > 0) {
            ...
            if (count((array)$Topics) > 0) {
                ...
                $response = [
                    ...
                    'topic_link' => "topic/" . $topic_id,
                    'topic_photo' => ($photo_file != "") ? url("") . "/uploads/topics/" . $photo_file : null,
                    'comments_count' => count((array)$response_details),
        ...
        if ($topic_id > 0) {
            ...
            if (count((array)$Topics) > 0) {
                ...
                $response = [
                    ...
                    'topic_link' => "topic/" . $topic_id,
                    'topic_photo' => ($photo_file != "") ? url("") . "/uploads/topics/" . $photo_file : null,
                    'related_topics_count' => count((array)$response_details),
        ...
        if ($topic_id > 0) {
            ...
            if (count((array)$Topics) > 0) {
                ...
                $response = [
                    ...
                    'topic_link' => "topic/" . $topic_id,
                    'topic_photo' => ($photo_file != "") ? url("") . "/uploads/topics/" . $photo_file : null,
                    'fields_count' => count((array)$response_details),
