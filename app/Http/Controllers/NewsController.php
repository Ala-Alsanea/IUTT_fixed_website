        ...
        if (count((array)$WebmasterSection) > 0) {
            ...
            if (@Auth::user()->permissionsGroup->view_status) {
               ...
               $Topics=$Topics->paginate(env('BACKEND_PAGINATION'));
                ...
                // ->
                   $Topics = Topic::where('webmaster_id', '=', $WebmasterSection->id)->orderby('row_no',
                    'asc')->paginate(env('BACKEND_PAGINATION'));
                  
                
            }
            return view("backEnd.news.index", compact("Topics", "GeneralWebmasterSections", "WebmasterSection"));
        } else {
...
$videoFileFinalName = "";
           ...
           if (isset($request->refrence_id)) {
            ...
            return redirect()->action('NewsController@index', [$webmasterId, $Topic->id])->with('doneMessage',
    ...
    public function edit($webmasterId, $id)
    {
        ...
        if (count((array)$WebmasterSection) > 0) {
            ...
            if (count((array)$Topics) > 0) {
                ...
                return redirect()->action('NewsController@index', $webmasterId);
            }
        } else {
            return redirect()->route('NotFound');
        }
    ...
    public function update(Request $request, $webmasterId, $id)
    {
        ...
        if (count((array)$WebmasterSection) > 0) {
           ...
           if (isset($request->refrence_id)) {
                ...
                return redirect()->action('NewsController@index', [$webmasterId, $id])->with('doneMessage',
    ...
    public function destroy($webmasterId, $id)
    {
        ...
        if (count((array)$WebmasterSection) > 0) {
            ...
            if (count((array)$Topic) > 0) {
                ...
                //Remove Topic
                $Topic->delete();
                return redirect()->action('NewsController@index', $webmasterId)->with('doneMessage',
    ...
    function seo(Request $request, $webmasterId, $id)
    {
        ...
        if (count((array)$WebmasterSection) > 0) {
            ...
            if (count((array)$Topic) > 0) {
                ...
                $Topic->save();
                return redirect()->action('NewsController@edit', [$webmasterId, $id])->with('doneMessage',
    ...
    public  function FileManagerPhotos(Request $request, $webmasterId, $id)
    {
        $WebmasterSection = WebmasterSection::find($webmasterId);
        if (count((array)$WebmasterSection) > 0) {
...
// Comments Functions
    ...
    function topicsComments($webmasterId, $id)
    {
        $WebmasterSection = WebmasterSection::find($webmasterId);
        if (count((array)$WebmasterSection) > 0) {
            return redirect()->action('NewsController@edit', [$webmasterId, $id])->with('activeTab', 'comments');
        } else {
            return redirect()->route('NotFound');
        }
    }
    ...
    function commentsCreate($webmasterId, $id)
    {
        ...
        if (count((array)$WebmasterSection) > 0) {
            ...
            return redirect()->action('NewsController@edit', [$webmasterId, $id])->with('activeTab',
...
// Maps Functions
    ...
    function topicsMaps($webmasterId, $id)
    {
        $WebmasterSection = WebmasterSection::find($webmasterId);
        if (count((array)$WebmasterSection) > 0) {
            return redirect()->action('NewsController@edit', [$webmasterId, $id])->with('activeTab', 'maps');
        } else {
            return redirect()->route('NotFound');
        }
    }
...
// Files Functions
    ...
    function topicsFiles($webmasterId, $id)
    {
        $WebmasterSection = WebmasterSection::find($webmasterId);
        if (count((array)$WebmasterSection) > 0) {
            return redirect()->action('NewsController@edit', [$webmasterId, $id])->with('activeTab', 'files');
        } else {
            return redirect()->route('NotFound');
        }
    }
...
// Related Topics Functions
    ...
    function topicsRelated($webmasterId, $id)
    {
        $WebmasterSection = WebmasterSection::find($webmasterId);
        if (count((array)$WebmasterSection) > 0) {
            return redirect()->action('NewsController@edit', [$webmasterId, $id])->with('activeTab', 'related');
        } else {
            return redirect()->route('NotFound');
        }
    }
